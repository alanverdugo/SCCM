...
destPath = "/opt/ibm/sccm/samples/logs/collectors/"
...
def checkMonth(year, month):
	...
	if curmon:
		...
		# TODO: fix bug. Every 1st day of the month, this takes "yesterday" as the
		# number of days of the previous month and check that number of days for 
		# the current month, which have not ocurred, obviously.
